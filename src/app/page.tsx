    ...
    <div className="flex flex-col min-h-screen bg-[#faf8f3]">
      ...
      <main className="flex-1">
        ...
        <section className="bg-[#faf8f3] py-16 px-6 md:px-20 text-center animate-fadeUp">
          <Image src="https://placehold.co/600x600.png" alt="Dr. Amiya Ballav Roy" width={160} height={160} className="w-40 h-40 rounded-full mx-auto shadow-lg mb-6 hover:scale-105 transition" data-ai-hint="male doctor smiling"/>
